#!/usr/bin/env python3
"""Install/remove the weekly low-frequency user LaunchAgent."""
...
LABEL = "com.highdividend.low-frequency-update"
...
def main() -> int:
    ...
    if args.uninstall:
        ...
        return 0
    runtime_script = RUNTIME_ROOT / "scripts" / "autonomous_low_frequency.py"
    ...
    payload["StandardOutPath"] = str(logs / "low-frequency-update.out.log")
    payload["StandardErrorPath"] = str(logs / "low-frequency-update.err.log")
