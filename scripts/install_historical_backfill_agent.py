#!/usr/bin/env python3
"""Install/remove the low-frequency historical-price backfill LaunchAgent."""
...
LABEL = "com.highdividend.historical-backfill"
...
def main() -> int:
    ...
    if args.uninstall:
        ...
        return 0
    runtime_script = RUNTIME_ROOT / "scripts" / "autonomous_history_backfill.py"
    ...
    payload["StandardOutPath"] = str(logs / "historical-backfill.out.log")
    payload["StandardErrorPath"] = str(logs / "historical-backfill.err.log")
